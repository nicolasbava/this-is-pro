                ...
                <div className="flex  z-10">
                    <div className="mx-auto md:pl-10 w-100 ">
                        <div className="flex-col flex  self-center p-10 sm:max-w-6xl xl:max-w-3xl z-10">
                            <h1 className="mb-3 text-xs font-bold leading-none tracking-tighter uppercase title-font md:text-h1-d lg:text-5xl">
                                {props.name}
                            </h1>
                            <p className="text-justify text-black title-font font-bold">
                                {props.description}
                            </p>
                            <div className="pt-6">
                                {props.pdf.map((data) => (
                                    <button
                                        className="mr-3 px-8 py-2 pt-3 leading-5 transition-colors duration-200 transform rounded-md focus:outline-none  shadow-lg"
