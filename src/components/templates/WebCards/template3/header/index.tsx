                        ...
                        <div className='md:inline-flex md:flex-row md:ml-auto md:w-auto w-full md:items-center items-start  flex flex-col md:h-auto'>
                            <div className="lg:pr-10">
                                <a
                                    ...
                                    className="text-sm leading-none tracking-tighter text-primary title-font uppercase mx-3 cursor-pointer hover:text-third2">
                                    INICIO
                                </a>
                            </div>
                            ...
                            <div className='lg:pl-10'>
                                <text
                                    ...
                                    className="text-sm leading-none tracking-tighter text-primary title-font uppercase mx-3 cursor-pointer hover:text-third2 z-99"
                                >
                                    COMPARTIR
                                </text>
                            </div>
