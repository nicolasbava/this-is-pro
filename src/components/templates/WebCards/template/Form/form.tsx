        ...
        <section className="lg:container px-10 py-6 mx-auto" >
            <form onSubmit={sendEmail}>
                ...
                <div className="flex justify-center mt-6">
                    <button
                        type='submit'
                        className="px-8 py-3 pt-4 leading-5 transition-colors duration-200 transform bg-primary rounded-md hover:bg-primary focus:outline-none focus:bg-primary shadow-lg" style={{ color: 'white' }}>
